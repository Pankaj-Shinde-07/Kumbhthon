          ...
          <div className="accommodation-content">
            ...
            <div className="accommodation-type">
              ...
              <div className="accommodation-grid">
                {accommodations.hotels.slice(0, showAllHotels ? accommodations.hotels.length : 5).map((hotel) => (
                ...
                {!showAllHotels && accommodations.hotels.length > 5 && (
                  <div className="see-all-card" onClick={() => setShowAllHotels(true)}>
            ...
            <div className="accommodation-type">
              ...
              <div className="accommodation-grid">
                {accommodations.homestays.slice(0, showAllHomestays ? accommodations.homestays.length : 5).map((homestay) => (
                ...
                {!showAllHomestays && accommodations.homestays.length > 5 && (
                  <div className="see-all-card" onClick={() => setShowAllHomestays(true)}>
                    <div className="see-all-content">
                      <i className="fas fa-plus-circle"></i>
            ...
            <div className="accommodation-type">
              ...
              <div className="accommodation-grid">
                {accommodations.tents.slice(0, showAllTents ? accommodations.tents.length : 5).map((tent) => (
                ...
                {!showAllTents && accommodations.tents.length > 5 && (
                  <div className="see-all-card" onClick={() => setShowAllTents(true)}>
                    <div className="see-all-content">
                      <i className="fas fa-plus-circle"></i>
                      <p>See All Tents</p>
          ...
          <div className="detail-page">
            ...
            <div className="detail-page-content">
              ...
              <div className="detail-page-info">
                ...
                <p className="detail-location"><i className="fas fa-map-marker-alt"></i> {selectedCard.location}</p>
                <div className="detail-rating-price">
                  <span className="detail-rating">{selectedCard.rating} ★</span>
                  <span className="detail-price">{selectedCard.price} / night</span>
                </div>
